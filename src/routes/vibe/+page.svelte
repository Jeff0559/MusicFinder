...
<style>
  :global(html[data-page="vibe"]) {
    background: url('/bg-vibe.gif?v=2') center/cover no-repeat fixed;
  }

  :global(body[data-page="vibe"]) {
    background: url('/bg-vibe.gif?v=2') center/cover no-repeat fixed;
  ...
  :global(body[data-page="vibe"] .app) {
    min-height: 100vh;
  ...
  .chip.active {
    ...
    border-color: #3de074;
    color: #e8ecf2;
    box-shadow: 0 0.5rem 1.25rem rgba(61, 224, 116, 0.2);
  ...
  .actions .play-btn:hover {
    transform: translateY(-0.0625rem);
    box-shadow: 0 0.5rem 1.125rem rgba(61, 224, 116, 0.2);
  }
  .actions {
    margin-top: auto;
  }
  ...
  .card.active {
    border-color: #3de074;
    box-shadow: 0 0 0 0.125rem rgba(61, 224, 116, 0.25);
  }
